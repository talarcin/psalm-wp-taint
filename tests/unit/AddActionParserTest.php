...
final class AddActionParserTest extends TestCase {
	...
	public function testParsingMultipleFiles(): void {
		$testFilePaths                  = [
			"./tests/res/psalm/files/test-file.php",
			"./tests/res/psalm/files/test-file-2.php"
		];
	...
	public function testCallWakeUp(): void {
		$this->expectException( \BadMethodCallException::class );

		$this->addActionParser->__wakeup();
	}
	...
	protected function cleanUp(): void {
		...
		$files                                   = [
			"./tests/res/actions-map.json",
			"./tests/res/actions-map-multiple.json"
		];
