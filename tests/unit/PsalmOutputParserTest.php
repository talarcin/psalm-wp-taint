...
class PsalmOutputParserTest extends TestCase
{
    ...
    public function testParseErrorMessageWithMultipleErrors(): void
    {
        $output = [
            ...
            "░░░░░░░░░░░░░░░░░░░",
            "",
            "ERROR: TaintedHtml - /home/tuncay/GitHub/wp-test-site/wp-content/plugins/vulnerable-wp-plugin/admin/Options.php:14:26 - Detected tainted HTML (see https://psalm.dev/245)",
            "  \$_POST",
            "    <no known location>",
            "",
            "  call to Options::set - wp-content/plugins/vulnerable-wp-plugin/admin/class-vulnerable-plugin-admin.php:134:18",
            ...
            "",
            "",
            "ERROR: TaintedHtml - /home/tuncay/GitHub/wp-test-site/wp-content/plugins/vulnerable-wp-plugin/admin/class-vulnerable-plugin-admin.php:146:9 - Detected tainted HTML (see https://psalm.dev/245)",
            "  \$_POST",
            "    <no known location>",
            "",
            ...
            "",
            "",
            "ERROR: TaintedTextWithQuotes - /home/tuncay/GitHub/wp-test-site/wp-content/plugins/vulnerable-wp-plugin/admin/class-vulnerable-plugin-admin.php:146:9 - Detected tainted text with possible quotes (see https://psalm.dev/274)",
            "  \$_POST",
            "    <no known location>",
            "",
            "  \$_POST['vulnerable_plugin_reflected_xss'] - wp-content/plugins/vulnerable-wp-plugin/admin/class-vulnerable-plugin-admin.php:146:9",
            ...
            "",
            "",
            "ERROR: TaintedFile - /home/tuncay/GitHub/wp-test-site/wp-content/plugins/vulnerable-wp-plugin/admin/class-vulnerable-plugin-admin.php:158:28 - Detected tainted file handling (see https://psalm.dev/255)",
            "  \$_POST",
            "    <no known location>",
            "",
